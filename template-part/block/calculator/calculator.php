...
<div id="calculator">
    ...
    padding: 0;
    padding-left: 10px;" for="nobackup"><span v-if="mspcheck == 'msp'">We</span><span v-else>I</span> don't currently
                backup <span v-if="mspcheck == 'msp'">their</span><span v-else>my</span> data</label></div>
        ...
        <div class="inputfield col-md-12 col-sm-12 nobk dualfield">
            ...
            <h6 class="col-md-6">
                ...
                start trouble shooting the downtime incident?</span> <span v-else>On average how long does it take you to notify your IT Service Provider that there is an issue and for them to
                start trouble shooting the downtime incident?</span>
            </h6>
            <div class="col-md-5 col-sm-12">
                <div class="dual">
        ...
        <div v-if="recoverytype !== 'local'" class="inputfield col-md-12 col-sm-12">
            ...
            <h6 class="col-md-7">What is the download speed from <span v-if="mspcheck == 'msp'">their</span><span
                    v-else>your</span> cloud backup location? <br/><span>Unsure? <a class="link"
    ...
    <section class="col-12">
        ...
        <div id="cost">
            ...
            <div class="inputfield col-md-12 col-sm-12">
                ...
                <h6 class="col-md-7">What is your <span v-if="mspcheck == 'msp'">clients'</span> businesses annual
                    revenue?</h6>
                <div class="col-md-4 col-sm-12">
                    <p class="pretag">{{currencyicon}}</p>
                    ...
                    <div id="current3">
                        <div>
                            ...
                            <div>
                                ...
                                <h6>
                                    Response Time you provided: <br/><strong style="color: #4d5967;">{{recoveryhrs}} hrs
    ...
    " v-if="recoverytype === 'local'"><strong>Warning:</strong> Having local only backups could leave you vulnerable to
                                    ...
                                    backup to really protect <span v-if="mspcheck == 'msp'">your clients'</span><span
                ...
                <div class="col-sm-12">
                    ...
                    <div id="datto3">
                        <div>
                            ...
                            <h6><span>*all losses are merely an estimation of losses associated with technology, and does not reflect a calculation of actual losses to your business.</span>
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12 col-sm-12" id="results" class="PDFMain">
                ...
                <div v-if="checked == ''">
                    ...
                    <p>
                        ...
                        & recovery solution you could be looking at a estimated potential loss of around <span
                ...
                <div v-else-if="checked == 'false'">
                    <p>With the information that you've provided, and using certain assumptions made based on how
                        businesses today typically function, we have estimated <span v-if="mspcheck == 'msp'">your clients'</span><span
                                v-else>your</span> downtime losses to be <strong>{{displayhourlyRevenueCost}} per
                            hour</strong>.</p>
                    <p>
                        With <span v-if="mspcheck == 'msp'">your clients'</span><span v-else>your</span> current backup
                        & recovery solution you could be looking at a estimated potential loss of around <strong><span
                ...
                <p><span v-if="mspcheck == 'msp'">In contrast,</span><span v-else>The first step is to talk to your IT service provider or MSP about Datto.</span>
                    ...
                    and <span v-if="mspcheck == 'msp'">thier</span><span v-else>your</span> overall downtime cost would
                    fall to <strong>{{ bcdrdowntimecost }}</strong>. In the rare case that the first recovery attempt
                ...
                <p>With Datto, even if you are experiencing an outage at your workplace, work doesn't have to stop.
                    Datto Continuity can get you back to business in a little as <strong>{{bcdrrecovery}}
