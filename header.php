...
<script type="application/ld+json"> 
{
  ...
  "@type": "LocalBusiness",
  "name": "Promedical IT",
  "telephone": "844.748.1437",
  "email": "support@promedicalit.com",
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "4901 NW 17th Way, STE 200",
...
<a href="/"><img src="<?php bloginfo( 'template_url' ) ?>/img/ProMed_Logo.svg" width="1257" height="191" alt="Promedical IT Logo - white" /></a>
</div>  
      ...
      <div class="o-wrapper-wide  u-relative "> 
        <div class="grid-x pt-3">
          <div class="cell medium-5">
            <img src="<?php bloginfo( 'template_url' ) ?>/img/ProMed_Logo.svg" width="1257" height="191" alt="Promedical IT Logo - white" />
